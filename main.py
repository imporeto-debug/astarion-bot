...
RECOMMEND_TOPICS = ("музыка", "кино", "фильмы", "сериалы", "игры", "книги", "музеи", "рестораны", "красивые места")
...
async def on_message(message):
    ...
    if is_long:
        prompt = (
            ...
            "Всего не более 20 предложений. "
            "Проверяй, чтобы места, музеи, рестораны и объекты реально существовали."
        )
